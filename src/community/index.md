...
规培笔记不仅是一个知识库，也是一个**同行交流的空间**。在这里分享你的临床经验、生活感悟、提问求助，或帮助我们改进内容。

## 参与方式

### 💬 在知识卡片下方评论

每一篇知识卡片底部都有评论区（由[Giscus](https://giscus.app)驱动，基于GitHub Discussions）。
...
> **只需一个GitHub账号即可评论。** 评论支持Markdown格式。
...
- 🫂 **尊重同行**：不人身攻击、不贬低他人的临床判断
- 🏥 **保护隐私**：不发布任何可识别患者身份的信息（姓名、住院号、影像含姓名等）
- 📝 **学术诚实**：分享经验时区分"已证实的证据"和"个人经验/习惯"
- 💊 **用药安全**：讨论药物时不推荐超说明书用法（除非同时引用依据）
- 🚫 **无广告**：不发布商业推广、不推荐特定产品
...
<a href="https://github.com/ayaosmile/residency-notes" style="display:inline-flex;align-items:center;gap:6px;padding:8px 16px;background:#24292f;color:white;border-radius:6px;text-decoration:none;font-size:14px">
  <svg width="20" height="20" viewBox="0 0 16 16" fill="white"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"/></svg>
  查看GitHub仓库
</a>

<a href="https://github.com/ayaosmile/residency-notes/discussions" style="display:inline-flex;align-items:center;gap:6px;padding:8px 16px;background:#0969da;color:white;border-radius:6px;text-decoration:none;font-size:14px">
  💬 进入Discussions
</a>
